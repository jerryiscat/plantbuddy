...
struct PlantDetailView: View {
    ...
    private var photoGalleryView: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            if let photos = plant.photos, !photos.isEmpty {
    ...
    private var quickActionsView: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [
                ...
                ActionButton(icon: "photo.fill", title: "Photo", color: .purple) {
            ...
            if let data = try await item.loadTransferable(type: Data.self),
               let image = UIImage(data: data) {
                ...
                if let jpegData = image.jpegData(compressionQuality: 0.8) {
                    ...
                    performAction("PHOTO", imageUrl: imageUrl)
                }
            }
        } catch {
            ...
            Button(action: onTap) {
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 8)
                        .stroke(isCover ? Color.blue : Color.clear, lineWidth: 3)
                )
            }
